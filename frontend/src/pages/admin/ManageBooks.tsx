      ...
      <ConfirmModal
        ...
        title={
          confirmDelete?.type === 'bulk'
            ? t('admin.books.confirmBulkTitle')
            : t('admin.books.confirmDeleteTitle')
        }
        message={
          confirmDelete?.type === 'bulk'
            ? t('admin.books.confirmBulkMsg', { count: confirmDelete.count ?? 0 })
            : t('admin.books.confirmDeleteMsg', { title: confirmDelete?.title ?? '' })
        }
        confirmLabel={t('admin.books.confirmDeleteConfirm')}
